...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspInit 0 */
    ...
    PA15     ------> SPI1_NSS 
    */
    GPIO_InitStruct.Pin = SX1276_SCK_Pin|SX1276_MISO_Pin|SX1276_MOSI_Pin|SX1276_CS_Pin;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PA15     ------> SPI1_NSS 
    */
    HAL_GPIO_DeInit(GPIOA, SX1276_SCK_Pin|SX1276_MISO_Pin|SX1276_MOSI_Pin|SX1276_CS_Pin);
